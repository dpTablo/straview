...
@Entity(name="activity_stream_grade_smooth")
@DiscriminatorValue("grade_smooth")
@AllArgsConstructor
@NoArgsConstructor
@Getter
@Setter
public class ActivityStreamGradeSmooth extends ActivityStream {
    @Column(name = "data")
    ...
    @Builder
    public ActivityStreamGradeSmooth(
